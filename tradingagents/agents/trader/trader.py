    ...
    def trader_node(state, name):
        ...
        try:
            atr_sizing_text = get_atr_position_sizing.invoke({
                ...
                "account_balance": sizing_config.get("account_balance", 10000.0),
                "risk_percent": sizing_config.get("risk_percent", 1.0),
            })
        except Exception:
        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Usa os dados ATR e o relatório técnico para fundamentar níveis absolutos de preço e posição. "
                    "Nunca escrevas uma percentagem num campo de preço. Se faltarem dados, indica indisponível. "
                    "Usa apenas a evidência fornecida; não chames ferramentas nem inventes dados."
                    + get_language_instruction()
                ),
            },
            {
