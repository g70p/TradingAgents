# Documentação histórica — backend API

Este documento descreve a arquitetura anterior e pode conter afirmações ainda não revistas. Não é o guia de instalação ou uso deste fork. Consulta o README principal.
